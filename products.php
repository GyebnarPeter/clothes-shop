...
<div class="products">
    ...
    <div class="products-box-wrapper">
        ...
        <div class="product-box">
            <div class="product-img"><img src="./img/bag-1.jpg" alt=""></div>
            <div class="separator"></div>
            <h4>red fantasy</h4>
            <div class="product-price">$99.0</div>
        ...
        <div class="product-box">
            <div class="product-img"><img src="./img/bag-2.jpg" alt=""></div>
            <div class="separator"></div>
            <h4>red fantasy</h4>
            <div class="product-price">$99.0</div>
            <button class="add-to-cart-btn">
        ...
        <div class="product-box">
            <div class="product-img"><img src="./img/bag-3.jpg" alt=""></div>
            <div class="separator"></div>
            <h4>red fantasy</h4>
            <div class="product-price">$99.0</div>
            <button class="add-to-cart-btn">
        ...
        <div class="product-box">
            <div class="product-img"><img src="./img/bag-4.jpg" alt=""></div>
            <div class="separator"></div>
            <h4>red fantasy</h4>
            <div class="product-price">$99.0</div>
            <button class="add-to-cart-btn">
